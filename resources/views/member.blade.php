...
<nav aria-label="breadcrumb">
  ...
  <h6 class="font-weight-bolder text-black mb-0">Data Member</h6>
</nav>
@stop
@section('content')
                    ...
                    <div class="col-12">
                      <div class="card mb-4">
                        <div class="card-header pb-0">
                          ...
                          <a href="{{route ('tambah-member')}}" class="btn btn-icon icon-left btn-success btn-gradient"><i class="far fa-edit"></i> Tambah Data</a>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="text-center">
                                    <span class="badge badge-sm bg-gradient-info ">{{$data->nama_member}}</span>
                                  </td>
                                  <td class="align-middle text-center text-sm">
