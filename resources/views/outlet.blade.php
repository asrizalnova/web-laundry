...
@section('navigasi')
  ...
  <h2 class="font-weight-bolder text-black mb-0">Data Outlet</h2>
</nav>
@stop
@section('content')
                    ...
                    <div class="col-12">
                      <div class="card mb-4">
                        <div class="card-header pb-0">
                          ...
                          <a href="{{route ('tambah-outlet')}}" class="btn btn-icon icon-left btn-primary btn-gradient"><i></i> Tambah Data</a>
                            ...
                            <table class="table align-items-center mb-0">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="align-middle text-center">
                                    <a href="{{route('edit-outlet',$data->id)}}" class="btn btn-icon btn-success"><i>edit</i></a>
